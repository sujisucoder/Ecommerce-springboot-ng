...
import com.example.ecommerce_backend.service.CustomUserServiceImplementation;
        ...
        try{
            if(authHeader != null && authHeader.startsWith("Bearer ")){
                ...
                if (username !=null && SecurityContextHolder.getContext().getAuthentication()== null){
                    System.out.println("extracted the username from token:"+username);
...
//                filterChain.doFilter(request,response);
            ...
            throw new ServletException("this is servlet exception"+e);
        }
